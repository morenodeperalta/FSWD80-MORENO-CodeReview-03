...
for(i=0; i<textUnderImage.length; i++){
	...
	document.getElementsByClassName("textUnderImage")[0].innerHTML+="<h3><font color='#474646'>"+textUnderImage[0].line2+"</font></h3>";
	document.getElementsByClassName("textUnderImage")[0].innerHTML+="<h3><font color='#474646'>"+textUnderImage[0].line3+"</font></h3>";
	document.getElementsByClassName("textUnderImage")[0].innerHTML+="<h3><font color='#474646'>"+textUnderImage[0].line4+"</font></h3>";
}
